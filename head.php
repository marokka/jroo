...
<html>
  <head>
    ...
    <link rel="shortcut icon" href="assets/images/JBS_Logo.png">
    ...
    <div id="main">
      <header>
            ...
            <div class="row">
              <div class="col-12 col-md-6">
                <div class="header-left d-flex flex-column flex-md-row align-items-center">
                  <p class="d-flex align-items-center"><i class="fas fa-map-marker-alt"></i>Крым, г. Ялта, ул. Игнатенко дом 3</p>
                  <p class="d-flex align-items-center"><i class="fas fa-phone"></i>+7(978)087-33-37</p>
                </div>
              </div>
              <div class="col-12 col-md-6">
                <div class="header-right d-flex flex-column flex-md-row justify-content-md-end justify-content-center align-items-center">
                  <div class="social-link d-flex"><a href=""><i class="fab fa-facebook-f"> </i></a><a href=""><i class="fab fa-vk"></i></a><a href=""><i class="fab fa-instagram"> </i></a></div>
                  <div class="login d-flex"><a href="login.html"><i class="fas fa-user"></i>Вход</a></div>
                </div>
              </div>
            </div>
          </div>
        ...
        <nav class="navigation d-flex align-items-center">
          <div class="container">
            <div class="row">
              <div class="col-2"><a class="logo" href="index.html"><img src="assets/images/JBS_Logo.png" alt="" style="width: 75%; margin-left: 40%"></a></div>
              <div class="col-8">
                <div class="navgition-menu d-flex align-items-center justify-content-center">
                  <ul class="mb-0">
                    <li class="toggleable"> <a class="menu-item active" href="shop_grid+list_3col.html">Меню <i class="fas fa-caret-down"></i></a>
                    ...
                    <li class="toggleable"><a class="menu-item" href="blog_list_sidebar.html">Оплата</a></li>
                    <li class="toggleable"> <a class="menu-item" href="about_us.php">Доставка</a></li>
                    <li class="toggleable"><a class="menu-item" href="contact.php">Контакты</a></li>
                  </ul>
                </div>
              </div>
              <div class="col-2">
                <div class="product-function d-flex align-items-center justify-content-end">
                  <div id="cart" ><a class="function-icon " style="font-size: 1.6em" href=""><i class="fas fa-shopping-basket"></i><span style="font-size: 1em">₽150.00</span></a></div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div id="mobile-menu">
          <div class="container">
            <div class="row">
                  ...
                  <div id="ogami-mobile-menu">
                    ...
                    <div class="mobile-menu_items">
                      <ul class="mb-0 d-flex flex-column">
                        <li class="toggleable"><a class="menu-item" href="shop_grid+list_3col.html">Меню</a><span class="sub-menu--expander"><i class="icon_plus"></i></span>
                          <ul class="sub-menu">
                            <li><a href="shop_grid+list_fullwidth.html">Меню Кухни</a></li>
                            <li><a href="shop_grid+list_fullwidth.html">Меню Напитков Б/А</a></li>
                          </ul>
              ...
              <div class="col-6">
                <div class="mobile-menu_logo text-center d-flex justify-content-center align-items-center"><a href=""><img src="assets/images/JBS_Logo.png" style="width: 65%" alt=""></a></div>
              </div>
              <div class="col-3">
                <div class="mobile-product_function d-flex align-items-center justify-content-end"><a class="function-icon" href="shop_cart.html"><i class="fas fa-shopping-basket" style="font-size: 2.4em"></i> </a></div>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="row">
              <div class="col-12 col-md-4 col-lg-4 col-xl-3 order-2 order-md-1">
                <div class="department-menu_block">
                  <div class="department-menu d-flex justify-content-between align-items-center"><i class="fas fa-bars"></i>Группировка<span><i class="arrow_carrot-down"></i></span></div>
                  ...
                  <div class="row no-gutters">
                    <div class="col-0 col-md-0 col-lg-4 col-xl-3">
                      <div class="filter-search">
                        <div class="categories-select d-flex align-items-center justify-content-around"><span>Все катигории</span><i class="arrow_carrot-down"></i></div>
                    ...
                    <div class="col-8 col-md-8 col-lg-5 col-xl-7">
                      <div class="search-input">
                        <input class="no-round-input no-border" type="text" placeholder="Поиск по блюдам">
                      </div>
                    </div>
